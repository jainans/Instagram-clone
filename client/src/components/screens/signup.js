  ...
  const PostData = ()=>{
    ...
    .then(data =>{
      if(data.error){
        ...
        M.toast({html: data.message, classes:"rounded #66bb6a green lighten-1"});
        history.push("/signin");
      }
      console.log(data);
    })
  ...
  return (
    <div className = "myCard">
      <div className="card auth-card input-field">
        ...
        <button className="btn waves-effect waves-light #e91e63 pink" onClick={()=>PostData()}>SignUp</button>
